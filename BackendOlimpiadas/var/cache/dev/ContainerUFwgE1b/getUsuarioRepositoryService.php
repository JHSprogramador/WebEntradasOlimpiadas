...
<<<<<<<< HEAD:BackendOlimpiadas/var/cache/dev/ContainerRUSVfYM/getUsuarioRepositoryService.php
namespace ContainerRUSVfYM;
========
namespace ContainerUFwgE1b;

>>>>>>>> d4c28e912e52caf526a829664115db5dc7736315:BackendOlimpiadas/var/cache/dev/ContainerUFwgE1b/getUsuarioRepositoryService.php
...
class getUsuarioRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UsuarioRepository.php';

        return $container->privates['App\\Repository\\UsuarioRepository'] = new \App\Repository\UsuarioRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
