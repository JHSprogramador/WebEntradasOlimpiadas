 ...
 */
class getUsuariosMesesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UsuariosMesesRepository' shared autowired service.
     *
     * @return \App\Repository\UsuariosMesesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UsuariosMesesRepository.php';

        return $container->privates['App\\Repository\\UsuariosMesesRepository'] = new \App\Repository\UsuariosMesesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
