 ...
 */
class getEstadioRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EstadioRepository' shared autowired service.
     *
     * @return \App\Repository\EstadioRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EstadioRepository.php';

        return $container->privates['App\\Repository\\EstadioRepository'] = new \App\Repository\EstadioRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
