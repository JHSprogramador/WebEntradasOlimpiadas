 ...
 */
class getDeporteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeporteRepository' shared autowired service.
     *
     * @return \App\Repository\DeporteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeporteRepository.php';

        return $container->privates['App\\Repository\\DeporteRepository'] = new \App\Repository\DeporteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
